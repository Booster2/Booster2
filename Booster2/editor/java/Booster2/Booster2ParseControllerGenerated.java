...
public class Booster2ParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Booster2");
  ...
  { 
    Booster2ParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = Booster2ParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = Booster2ParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(Booster2ParseControllerGenerated.class);
    }
  ...
  { 
    return Booster2ParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
