...
drop table if exists mainClass_att24;
create table mainClass_att24 (mainClass_att24Id int   auto_increment primary key );

alter table mainClass_att24
	add column mainClassId int     , add foreign key (mainClassId) references mainClass ( mainClassId);
alter table mainClass_att24
	add column att24 datetime     ;
...
alter table mainClass
	add column att23 datetime null default null   ;
...
(class, attName, primType, typeMultiplicity, oppAttName, className, setName, direction, tableName, isId)
values
('mainClass','att23','DateTime','Optional',null,'','','Uni','mainClass',0)
 ;
insert  
into
_Meta_Attributes
(class, attName, primType, typeMultiplicity, oppAttName, className, setName, direction, tableName, isId)
values
('mainClass','att24','DateTime','Set',null,'','','Uni','mainClass_att24',0)
 ;
insert  
into
_Meta_Methods
