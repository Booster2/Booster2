...
public class Booster25ParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Booster25");
  ...
  { 
    Booster25ParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = Booster25ParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = Booster25ParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(Booster25ParseControllerGenerated.class);
    }
  ...
  { 
    return Booster25ParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
